  ...
  return (
    <div className="mx-auto max-w-5xl flex-1 p-6">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-text-secondary">Overview of your assessment activity</p>
      </div>
      ...
      <div className="grid gap-5 sm:grid-cols-3">
        <div className="rounded-xl border border-border bg-white p-5 shadow-card transition-shadow hover:shadow-card-hover">
          ...
          <p className="text-sm font-medium text-text-secondary">Assessment Templates</p>
          <p className="mt-1 text-3xl font-bold tracking-tight text-text">{totalAssessments}</p>
        </div>
        <div className="rounded-xl border border-border bg-white p-5 shadow-card transition-shadow hover:shadow-card-hover">
          ...
          <p className="mt-1 text-3xl font-bold tracking-tight text-text">{inProgress}</p>
        </div>
        <div className="rounded-xl border border-border bg-white p-5 shadow-card transition-shadow hover:shadow-card-hover">
          ...
          <p className="mt-1 text-3xl font-bold tracking-tight text-text">{delivered}</p>
        </div>
      </div>
      ...
      <div className="mt-10">
        ...
        <div className="flex gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-border bg-white px-5 py-2.5 text-sm font-semibold text-text transition-colors hover:bg-surface-secondary active:scale-[0.98]"
          >
